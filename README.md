...
- Timestamp: `2022-06-07 16:43`
- Build ID: `6a6d2430-0b21-4d5d-a2e7-63731fc0f143`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/6a6d2430-0b21-4d5d-a2e7-63731fc0f143.git
$ cd 6a6d2430-0b21-4d5d-a2e7-63731fc0f143
```
